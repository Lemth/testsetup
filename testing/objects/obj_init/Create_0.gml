...
for (var i=1;i<=room_last;i++) {
	if(room_exists(i)) {
		room_set_viewport(i,0,true,0,0,round(global.resolution_height*16/9),global.resolution_height);
		room_set_view_enabled(i,true);
	}
}

// RESIZE APP SURFACE
surface_resize(application_surface,round(global.resolution_height*16/9),global.resolution_height);
